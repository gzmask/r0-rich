...
(def dev_news [{:title "PHP Rant" 
                ...
                :body [:div "PHP, as we know it for helplessly being the most popular Web language, are creating the marjor problems more developers facing. Is the problem laying in the language itself? Maybe, but not likely. But there is one fact that we can not ignore: " [:h3 "PHP attracts more than its fair share of the talentless."] " Now, stay away from it." ]}
